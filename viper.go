...
func (v *Viper) getKeyValueConfig() error {
	if RemoteConfig == nil {
		return RemoteConfigError("Enable the remote features by doing a blank import of the viper/remote package: '_ github.com/legenove/viper/remote'")
	}
...
func (v *Viper) searchInPath(in string) (filename string) {
	...
	if exts, ok  := SupportedExts[v.configType]; ok {
